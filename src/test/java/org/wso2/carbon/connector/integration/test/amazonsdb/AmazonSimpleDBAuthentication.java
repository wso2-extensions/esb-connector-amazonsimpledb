...
public class AmazonSimpleDBAuthentication {
     ...
     * @throws java.io.UnsupportedEncodingException   This exception is thrown when the Character Encoding is not
     *                                                supported
     * @throws java.security.NoSuchAlgorithmException This exception is thrown when a particular cryptographic algorithm is
